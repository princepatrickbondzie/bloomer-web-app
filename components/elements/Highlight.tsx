      ...
      <div className=" grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 lg:gap-8 gap-6 ">
        ...
        <div className=" p-6 bg-gray-50">
          ...
          <Link legacyBehavior href="/store">
            <a className="cursor-pointer underline text-base leading-4 font-medium text-gray-800 border-b-2 border-gray-800 hover:text-gray-600 ">
              Learn More
            </a>
          </Link>
        </div>
        ...
        <div className=" p-6 bg-gray-50">
          ...
          <p className=" font-normal text-base leading-6 text-gray-600 my-4">
            Free shipping all over the world on orders above{" "}
          </p>
          <Link legacyBehavior href="/store">
            <a className="cursor-pointer underline text-base leading-4 font-medium text-gray-800 border-b-2 border-gray-800 hover:text-gray-600 ">
              Learn More
